...
export default function CategoriesPage() {
  ...
  const fetchCategories = async () => {
    ...
    const { data, error } = await supabase
      .from('categories')
      .select('id, name, type, is_visible, user_id, group_id, parent_id, sort_order')
          ...
          <div className="flex flex-col">
            {rootCategories.map((rootCat) => (
              ...
              <div
                ...
                onDrop={(e) => handleDrop(e, rootCat.id, null)}
              ...
              >
                ...
                <div className="cursor-grab active:cursor-grabbing text-gray-300 hover:text-gray-500 shrink-0">
                  ...
                  {/* 상위 카테고리 가시성 토글 */}
                  <button
                    onClick={() => toggleVisible(rootCat)}
                    className="text-lg shrink-0"
                    title={rootCat.is_visible ? '숨기기' : '표시하기'}
                  >
                    {rootCat.is_visible ? '👁' : '🙈'}
                  </button>
